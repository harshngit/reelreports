                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                        ...
                        <div className="space-y-6 sm:space-y-8 order-1 md:order-2">
                            ...
                            <div className="grid grid-cols-3 gap-3 sm:gap-6 py-4 sm:py-6 border-y border-gray-200">
                                <div>
                                    <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-1">4K</div>
                                    <div className="text-xs sm:text-sm text-gray-600">HD Quality</div>
                                </div>
                                <div>
                                    <div className="text-2xl sm:text-3xl font-bold text-cyan-600 mb-1">Real</div>
                                    <div className="text-xs sm:text-sm text-gray-600">Time Render</div>
                                </div>
                                <div>
                                    <div className="text-2xl sm:text-3xl font-bold text-teal-600 mb-1">Auto</div>
                                    <div className="text-xs sm:text-sm text-gray-600">Adaptive</div>
                                </div>
                            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="bg-white rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="bg-gradient-to-br from-slate-50 to-indigo-50 p-6 sm:p-8 md:p-12">
