			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
					{cards.map((card, idx) => (
						...
						>
							<div className="w-12 h-12 mr-4 rounded-xl flex items-center justify-center flex-shrink-0" style={{backgroundImage:'linear-gradient(90deg, #0118D8 0%, #B771E5 100%)'}}>
